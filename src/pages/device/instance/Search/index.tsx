        ...
        <Col md={8} sm={24} key="parameter">
          <Input.Group compact>
            {getFieldDecorator('parameter', {
              ...
              >
                <Select.Option value="id$like" key="id$like">
                  设备ID
                </Select.Option>
                <Select.Option value="name$like" key="name$like">
                  设备名称
                </Select.Option>
                <Select.Option value="orgId$in" key="orgId$in">
                  所属机构
                </Select.Option>
                {/*<Select.Option value="id$dev-tag" key="id$dev-tag">设备标签</Select.Option>*/}
                <Select.Option value="productId$dev-prod-cat" key="productId$dev-prod-cat">
                  所属品类
                </Select.Option>
